...
.e-message .e-msg-close-icon:hover, .e-message .e-msg-close-icon:focus {
  ...
  -webkit-box-shadow: 0 0 0 2px rgba(209, 213, 219, 0.12);
          box-shadow: 0 0 0 2px rgba(209, 213, 219, 0.12);
  border-radius: 50%;
}
.e-message.e-success {
...
.e-message.e-error .e-msg-icon {
  color: #f87171 !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-message.e-filled.e-success .e-msg-close-icon:hover, .e-message.e-filled.e-success .e-msg-close-icon:focus {
  ...
  -webkit-box-shadow: 0 0 0 2px rgba(31, 41, 55, 0.12);
...
.e-message.e-filled.e-error .e-msg-icon {
  color: #1f2937 !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-message.e-bigger .e-msg-close-icon:focus {
  -webkit-box-shadow: 0 0 0 4px rgba(209, 213, 219, 0.12);
          box-shadow: 0 0 0 4px rgba(209, 213, 219, 0.12);
}
...
.e-message.e-bigger.e-filled.e-success .e-msg-close-icon:focus {
  -webkit-box-shadow: 0 0 0 4px rgba(31, 41, 55, 0.12);

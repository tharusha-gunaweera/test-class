...
.e-message .e-msg-close-icon:hover, .e-message .e-msg-close-icon:focus {
  ...
  -webkit-box-shadow: 0 0 0 2px rgba(52, 58, 64, 0.12);
...
.e-message.e-error .e-msg-icon {
  color: #dc3545 !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-message.e-bigger .e-msg-close-icon:focus {
  -webkit-box-shadow: 0 0 0 4px rgba(52, 58, 64, 0.12);
          box-shadow: 0 0 0 4px rgba(52, 58, 64, 0.12);
}
